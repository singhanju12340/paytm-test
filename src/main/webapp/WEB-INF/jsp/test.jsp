...
public void changePermission(){
    try{
        ...
        permission.setDbPermission(operation_type);
        permission.setEnvironment(environment);
        permission.setPanelPermission(panelPermission);
        userService.changeUserPermission(permission, name);
    }catch(Exception e){
...
<input type="Submit" value="Submit" onclick="changePermission()">

</div>
<%!
String panelPermission;
String environment;
String operation_type;

%>
<%
 panelPermission = request.getParameter("panel_parameter");
environment = request.getParameter("environment");
operation_type= request.getParameter("operation");
